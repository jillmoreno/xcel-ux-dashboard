...
const _LEARNING_PATHS_BY_BRAND: Record<Brand, LearningPathSummary[]> = {
  // Colibri Real Estate — NC is the primary licensed state; GA + luxury
  // designation rounds out the picker per colibrirealestate.com.
  cre: [
    {
      id: 'cre-nc-ce-renewal',
      title: 'North Carolina Real Estate CE Renewal',
      category: 'Real Estate Continuing Education',
      state: 'NC',
      hours: 50,
      licenseExpiresOn: '06/30/2026',
      timeLeftLabel: '6 Weeks Left to Renewal',
      // 13 of 50 required credit hours complete → 26%.
      progressPct: 26,
      lastViewedAt: '2026-05-19T09:30:00Z',
      mandatory: { completed: 9, required: 30 },
      elective: { completed: 4, required: 20 },
    },
    {
      id: 'cre-ga-first-renewal',
      title: 'Georgia First-Time Renewal Package',
      category: 'Real Estate Continuing Education',
      state: 'GA',
      hours: 25,
      licenseExpiresOn: '12/31/2026',
      progressPct: 12,
      lastViewedAt: '2026-05-10T14:15:00Z',
      mandatory: { completed: 1, required: 4 },
      elective: { completed: 2, required: 21 },
    },
    {
      id: 'cre-luxury-designation',
      title: 'Luxury Home Marketing Specialist Designation',
      category: 'Professional Designation',
      hours: 16,
      progressPct: 0,
      lastViewedAt: '2026-03-22T11:00:00Z',
    },
  ],
  // McKissock Learning — federal USPAP cycle drives the primary path; TX
  // biennial CE + supervisor course mirror the popular CE Membership tracks.
  mckissock: [
    {
      id: 'mck-uspap-2026-2027',
      title: '2026-2027 USPAP + Valuation Bias Update',
      category: 'Appraisal Continuing Education',
      state: 'Federal',
      hours: 14,
      licenseExpiresOn: '12/31/2027',
      timeLeftLabel: 'Renewal Cycle Through 2027',
      progressPct: 50,
      lastViewedAt: '2026-05-18T13:45:00Z',
      mandatory: { completed: 7, required: 14 },
    },
    {
      id: 'mck-tx-appraisal-ce',
      title: 'Texas Appraisal Biennial CE Renewal',
      category: 'Appraisal Continuing Education',
      state: 'TX',
      hours: 28,
      licenseExpiresOn: '08/31/2027',
      progressPct: 30,
      lastViewedAt: '2026-05-12T10:20:00Z',
      mandatory: { completed: 7, required: 14 },
      elective: { completed: 2, required: 14 },
    },
    {
      id: 'mck-supervisor-trainee',
      title: 'Supervisory Appraiser / Trainee Appraiser Course',
      category: 'Appraiser Qualification',
      hours: 4,
      progressPct: 0,
      lastViewedAt: '2026-04-02T15:00:00Z',
    },
  ],
  // Elite Learning — FL biennial renewal (24 hrs + HIV/AIDS one-time)
  // is the headline path; RN specialty recert + APRN pharm round it out.
  elite: [
    {
      id: 'elite-fl-nursing-ce',
      title: 'Florida Nursing CE Biennial Renewal',
      category: 'Nursing Continuing Education',
      state: 'FL',
      hours: 24,
      licenseExpiresOn: '07/31/2026',
      timeLeftLabel: '10 Weeks Left to Renewal',
      // 14 of 25 required credit hours (6/9 mandatory + 8/16 elective) = 56%,
      // matching the gauge the widget derives from the breakdown.
      progressPct: 56,
      lastViewedAt: '2026-05-20T08:15:00Z',
      mandatory: { completed: 6, required: 9 },
      elective: { completed: 8, required: 16 },
    },
    {
      id: 'elite-rn-specialty-recert',
      title: 'RN-BC Pediatric Specialty Recertification',
      category: 'Specialty Certification',
      hours: 30,
      licenseExpiresOn: '03/31/2027',
      timeLeftLabel: '40 Weeks Left to Renewal',
      // 5 of 30 required hours (2/12 mandatory + 3/18 elective) = 17%.
      progressPct: 17,
      lastViewedAt: '2026-05-08T16:40:00Z',
      mandatory: { completed: 2, required: 12 },
      elective: { completed: 3, required: 18 },
      // Jump Back In course when this is the active path.
      jumpBackIn: {
        id: 'jbi-elite-rn-peds-assessment',
        title: 'Pediatric Assessment & Triage',
        hours: 6,
        state: 'National',
        delivery: 'online',
        badge: 'mandatory',
    ...
    {
      id: 'elite-aprn-pharm',
      title: 'APRN Pharmacology Update Collection',
      category: 'Advanced Practice CE',
      hours: 25,
      licenseExpiresOn: '09/30/2027',
      timeLeftLabel: '72 Weeks Left to Renewal',
      // Not started — 0 of 25 required hours. The Mandatory/Elective lines still
      // render (both empty) so every path reads consistently.
      progressPct: 0,
      lastViewedAt: '2026-04-15T12:00:00Z',
      mandatory: { completed: 0, required: 10 },
      elective: { completed: 0, required: 15 },
      jumpBackIn: {
        id: 'jbi-elite-aprn-pharm-foundations',
        title: 'Advanced Pharmacology Foundations',
        hours: 5,
        state: 'National',
        delivery: 'online',
        badge: 'mandatory',
  ...
  // STC — securities industry exam-prep (already aligned with stcusa.com).
  stc: [
    {
      id: 'series-79-15day',
      title: 'Series 79 Investment Banking Representative Learning Path',
      category: 'Securities Industry Exam Prep',
      hours: 35,
      examDate: '05/27/2026',
      timeLeftLabel: '2 Weeks (8 Days) Left to Exam',
      progressPct: 85,
      lastViewedAt: '2026-05-19T08:00:00Z',
      // Adopts the redesigned in-tab Study Calendar; the underlying
      // state (empty / edit / locked) is driven by the
      // `study-calendar-state` feature flag rather than separate
      // path entries.
    ...
    },
    {
      ...
      hours: 75,
      examDate: '07/15/2026',
      timeLeftLabel: '8 Weeks Left to Exam',
      progressPct: 12,
      lastViewedAt: '2026-05-18T16:00:00Z',
      // Off-track variant in the 3-path STC demo trio (Series 79
      // on-track, Series 7 off-track, Series 63 not-started). Adopts
      // the redesigned in-tab Study Calendar so the overdue task
      // styling + status copy match the rest of the demo.
      layoutVariant: 'study-calendar-in-tab',
    },
    {
      id: 'series-63-statelaw',
      title: 'Series 63 — Uniform Securities Agent State Law',
      category: 'Securities Industry Exam Prep',
      hours: 25,
      examDate: '08/22/2026',
      timeLeftLabel: '13 Weeks Left to Exam',
      progressPct: 0,
      lastViewedAt: '2026-04-10T09:30:00Z',
      // Not-started variant in the 3-path STC demo trio. Adopts the
      // redesigned in-tab Study Calendar so the 0% / all-upcoming
      // tasks render through the new layout.
      layoutVariant: 'study-calendar-in-tab',
    },
  ],
 ...
 *  brand per AccountContext. Prefer `learningPathsFor(brand)` in new code. */
export const LEARNING_PATHS: LearningPathSummary[] = _LEARNING_PATHS_BY_BRAND.cre
...
const _LEARNING_PATH_CARDS_BY_BRAND: Record<Brand, LearningPathCardData[]> = {
  cre: [
    {
      id: 'cre-nc-ce-renewal',
      title: 'North Carolina Real Estate CE Renewal',
      programType: 'Real Estate Continuing Education',
      credentialType: 'CE',
      jurisdiction: 'NC',
      totalHours: 8,
      status: 'on-track',
      ...
      daysLeftToComplete: 41,
      totalTimeSpent: { hours: 4.5 },
      lastActivityDays: 1,
      resumeUrl: '/my-learning/path?id=cre-nc-ce-renewal',
    },
    {
      id: 'cre-ga-first-renewal',
      title: 'Georgia First-Time Renewal Package',
      ...
      daysLeftToComplete: 225,
      totalTimeSpent: { hours: 2.5 },
      lastActivityDays: 10,
      resumeUrl: '/my-learning/path?id=cre-ga-first-renewal',
    },
    {
      id: 'cre-luxury-designation',
      title: 'Luxury Home Marketing Specialist Designation',
      programType: 'Professional Designation',
      credentialType: 'Path',
      ...
      enrolledDate: null,
      expiresDate: null,
      daysLeftToComplete: null,
      totalTimeSpent: null,
      lastActivityDays: null,
      resumeUrl: '/my-learning/path?id=cre-luxury-designation',
    },
  ],
  mckissock: [
    {
      id: 'mck-uspap-2026-2027',
      title: '2026-2027 USPAP + Valuation Bias Update',
      programType: 'Appraisal Continuing Education',
      credentialType: 'CE',
      ...
      daysLeftToComplete: 590,
      totalTimeSpent: { hours: 6.5 },
      lastActivityDays: 2,
      resumeUrl: '/my-learning/path?id=mck-uspap-2026-2027',
    },
    {
      id: 'mck-tx-appraisal-ce',
      title: 'Texas Appraisal Biennial CE Renewal',
      ...
      daysLeftToComplete: 468,
      totalTimeSpent: { hours: 8 },
      lastActivityDays: 8,
      resumeUrl: '/my-learning/path?id=mck-tx-appraisal-ce',
    },
    {
      id: 'mck-supervisor-trainee',
      title: 'Supervisory Appraiser / Trainee Appraiser Course',
      programType: 'Appraiser Qualification',
      credentialType: 'Path',
      jurisdiction: 'Federal',
      totalHours: 4,
      status: 'not-started',
      ...
      totalTimeSpent: null,
      lastActivityDays: null,
      resumeUrl: '/my-learning/path?id=mck-supervisor-trainee',
    },
  ],
  elite: [
    {
      id: 'elite-fl-nursing-ce',
      title: 'Florida Nursing CE Biennial Renewal',
      programType: 'Nursing Continuing Education',
      credentialType: 'CE',
      jurisdiction: 'FL',
      totalHours: 24,
      status: 'on-track',
      ...
      daysLeftToComplete: 72,
      totalTimeSpent: { hours: 13 },
      lastActivityDays: 0,
      resumeUrl: '/my-learning/path?id=elite-fl-nursing-ce',
    },
    {
      id: 'elite-rn-specialty-recert',
      title: 'RN-BC Pediatric Specialty Recertification',
      programType: 'Specialty Certification',
      ...
      daysLeftToComplete: 315,
      totalTimeSpent: { hours: 4 },
      lastActivityDays: 12,
      resumeUrl: '/my-learning/path?id=elite-rn-specialty-recert',
    },
    {
      id: 'elite-aprn-pharm',
      title: 'APRN Pharmacology Update Collection',
      programType: 'Advanced Practice CE',
      credentialType: 'CE',
      jurisdiction: 'National',
      totalHours: 25,
      status: 'not-started',
      ...
      totalTimeSpent: null,
      lastActivityDays: null,
      resumeUrl: '/my-learning/path?id=elite-aprn-pharm',
    },
  ],
  fitzgerald: [
    {
  ...
  // STC-aligned demo paths covering the three most common FINRA tracks the
  // platform sells (per stcusa.com Series 7 Top-Off + Series 79 + Series 63).
  stc: [
    {
      id: 'series-79-15day',
      title: 'Series 79 Investment Banking Representative',
      programType: 'Securities Industry Exam Prep',
      credentialType: 'Exam Prep',
      jurisdiction: 'FINRA',
      totalHours: 35,
      // 8 days to exam day → time-pressure 'at-risk' treatment.
      status: 'at-risk',
      progressPct: 85,
      hoursCompleted: 30,
      enrolledDate: '2026-03-15',
      expiresDate: '2026-05-27',
      daysLeftToComplete: 8,
      totalTimeSpent: { hours: 28 },
      lastActivityDays: 1,
      resumeUrl: '/my-learning/path?path=series-79-15day',
    },
    {
      id: 'series-7-topoff',
      title: 'Series 7 Top-Off — General Securities Representative',
      ...
      daysLeftToComplete: 56,
      totalTimeSpent: { hours: 8.5 },
      lastActivityDays: 2,
      resumeUrl: '/my-learning/path?path=series-7-topoff',
    },
    {
      id: 'series-63-statelaw',
      title: 'Series 63 — Uniform Securities Agent State Law',
      ...
      enrolledDate: null,
      expiresDate: null,
      daysLeftToComplete: 90,
      totalTimeSpent: null,
      lastActivityDays: null,
      resumeUrl: '/my-learning/path?path=series-63-statelaw',
    },
  ],
...
export const LEARNING_PATH_CARDS: LearningPathCardData[] = _LEARNING_PATH_CARDS_BY_BRAND.cre
...
const _MANDATORY_BY_BRAND: Record<Brand, CourseCardData[]> = {
  // Real-estate broker / agent CE — North Carolina is the primary licensed
  // state. NC requires 8 hrs / cycle: 4 hrs in the live General Update
  // (or BICUP for brokers-in-charge) plus 4 elective. Course titles taken
  // from the NC CE catalog on colibrirealestate.com (2026-2027 cycle).
  cre: [
    {
      id: 'lp-cre-nc-update',
      title: '2025-2026 NC General Update',
      hours: 4,
      state: 'NC',
      // NC requires the Update course in a live instructor-led setting.
      // CourseDelivery doesn't carry a 'webinar' option, so we use 'video'
      // (the closest match for the live-stream version Colibri sells).
      delivery: 'video',
      badge: 'mandatory',
      status: 'completed',
    },
    {
      id: 'lp-cre-nc-bicup',
      title: '2025-2026 Broker-in-Charge Update (BICUP)',
      hours: 4,
      state: 'NC',
      delivery: 'video',
      badge: 'mandatory',
  ...
  // Appraisal CE — McKissock is the sole asynchronous host of the
  // 2026-2027 7-Hour National USPAP CE Course, paired with the 7-hr
  // National Valuation Bias and Fair Housing course. The remaining
  // electives come from the live McKissock CE Membership catalog.
  mckissock: [
    {
      id: 'lp-mck-uspap-26-27',
  ...
  // Nursing CE — Florida biennial renewal. 9 hrs of mandatory topics (Medical
  // Errors 2hr, FL Laws & Rules 2hr, Recognizing Impairment 2hr, Human
  // Trafficking 2hr, one-time HIV/AIDS 1hr) + elective general CE. Statuses are
  // authored to match `elite-fl-nursing-ce`'s breakdown (mandatory 6/9,
  // elective 8/16) so the Learning Path detail panel's course lists sum to the
  // gauge. Completed courses carry a `certificateHref`. Titles match the Elite
  // Learning FL catalog.
  elite: [
    {
      id: 'lp-elite-medical-errors',
      ...
      badge: 'mandatory',
      status: 'completed',
      certificateHref: '/my-learning/certificates',
    },
    {
      id: 'lp-elite-fl-laws',
    ...
    // Elective CE counting toward the renewal's general hours — drives the
    // detail panel's Elective list; the two completed ones carry a cert target.
    {
      id: 'lp-elite-pain-management',
    ...
    {
      id: 'lp-elite-mental-health-first-aid',
  ...
  // Securities exam prep — STC's specialty. SIE-first, then Series 7 Top-Off
  // and the state-law follow-ups.
  stc: [
    {
      id: 'lp-stc-sie',
      title: 'SIE Exam Prep',
...
/** STC Learning Paths the demo treats as "not yet started" — every
 *  mandatory card renders at 0% and the linked Study Calendar surfaces no
 *  completed tasks. Other paths still show their normal in-progress /
 *  complete states. */
const STC_NOT_STARTED_PATH_IDS = new Set<string>([
  'series-63-statelaw',
...
/**
 * Per-path Mandatory override for the STC Series 79 learning path.
 * Replaces the shared `_MANDATORY_BY_BRAND.stc` list (SIE / S7 / S63 / S65 /
 * S66) with the seven study materials that ship with the Series 79
 * Top-Off prep package per stcusa.com's reference layout:
 *
 *   1. Study Manual
 *   2. On Demands              (on-demand video lecture)
 *   3. Chapter Quizzes
 *   4. Flashcards
 *   5. Progress Exams           (progress + greenlight)
 *   6. Final Exams              (final + custom)
 *   7. Class Recording          (virtual class playback)
 *
 * Hours are plausible defaults — the reference UI doesn't carry a
 * per-item duration so the platform owners can dial these in later.
 * Every item ships as Mandatory / Online / US. The natural shape is
 * Not Started 0%; the per-status progression below
 * (`_SERIES_79_STATUS_PROGRESSION`) is layered on top by
 * `mandatoryCoursesFor` so the same `study-calendar-status` feature
 * flag that transforms the Study Calendar tasks also drives the card
 * statuses — reviewers can flip On Track / Off Track / Not Started
 * from the Feature Flag panel and see the cards react.
 *
 * Expiry dates from the reference (On Demands 11-18-26, Chapter
 * Quizzes 11-23-26, Final Exams 08-30-26) are intentionally omitted —
 * `CourseCardData` doesn't carry an expiry field today and the user
 * elected to defer expiry surfacing to a follow-up.
 */
const _SERIES_79_MANDATORY_ITEMS: Omit<CourseCardData, 'imageUrl'>[] = [
  {
    id: 'lp-stc-s79-study-manual',
    title: 'Study Manual',
    hours: 15,
    state: 'US',
    delivery: 'online',
...
const _SERIES_79_STATUS_PROGRESSION: Record<
  string,
  Record<StatusOverride, CardStatusEntry>
> = {
  'lp-stc-s79-study-manual': {
    match: { status: 'completed', progress: 100 },
    'on-track': { status: 'completed', progress: 100 },
    'off-track': { status: 'in-progress', progress: 35 },
    'not-started': {},
  },
  'lp-stc-s79-on-demands': {
    match: { status: 'completed', progress: 100 },
    'on-track': { status: 'completed', progress: 100 },
    'off-track': {},
    'not-started': {},
  },
  'lp-stc-s79-chapter-quizzes': {
    match: { status: 'in-progress', progress: 60 },
    'on-track': { status: 'in-progress', progress: 60 },
    'off-track': {},
    'not-started': {},
  },
  'lp-stc-s79-flashcards': {
    match: { status: 'in-progress', progress: 25 },
    'on-track': { status: 'in-progress', progress: 25 },
    'off-track': {},
    'not-started': {},
  },
  'lp-stc-s79-progress-exams': {
    match: {},
    'on-track': {},
    'off-track': {},
    'not-started': {},
  },
  'lp-stc-s79-final-exams': {
    match: {},
    'on-track': {},
    'off-track': {},
    'not-started': {},
  },
  'lp-stc-s79-class-recording': {
    match: {},
    'on-track': {},
    'off-track': {},
    'not-started': {},
...
export function mandatoryCoursesFor(
  ...
  if (brand === 'stc' && pathId === 'series-79-15day') {
    return _SERIES_79_MANDATORY_ITEMS.map((c, i) => {
      const progression =
        _SERIES_79_STATUS_PROGRESSION[c.id]?.[statusOverride] ?? {}
      return {
        ...c,
  ...
  if (brand === 'stc' && pathId && STC_NOT_STARTED_PATH_IDS.has(pathId)) {
    // Strip status + progress so each card reads as not-started (0%). Keep
    // `gated` / `purchaseChip` so the visual hierarchy of paid-but-locked
    // courses still renders.
    return list.map(({ status: _status, progress: _progress, ...rest }) => rest)
  }
  return list
}
...
const _MANDATORY_HOURS_BY_BRAND: Record<Brand, { earned: number; required: number }> = {
  cre: { earned: 6, required: 8 }, // NC broker CE — 4 mandatory + 4 elective
  mckissock: { earned: 10, required: 14 }, // USPAP 7 + Bias 7 federal mandatory
  elite: { earned: 4, required: 9 }, // FL nursing — 8 mandatory + 1 HIV one-time
  fitzgerald: { earned: 4, required: 9 }, // FL nursing — 8 mandatory + 1 HIV one-time
  stc: { earned: 47, required: 75 }, // SIE + S7 prep hours
...
const _CERTS_BY_BRAND: Record<Brand, CertSmallData[]> = {
  // Mix of NC mandatory + popular electives from the Colibri CE catalog.
  cre: [
    { id: 'cre-cert-1', title: '2025-2026 NC General Update', hours: 4, tier: 'mandatory' },
    { id: 'cre-cert-2', title: 'Broker-in-Charge Update (BICUP)', hours: 4, tier: 'designated-mandatory' },
    { id: 'cre-cert-3', title: 'Ethics on the Go: Quick Cases for Busy Agents', hours: 4, tier: 'elective' },
    { id: 'cre-cert-4', title: 'Fair Housing — Source-of-Income Protections', hours: 4, tier: 'elective' },
    { id: 'cre-cert-5', title: 'Performing Quality BPOs', hours: 3, tier: 'elective' },
    { id: 'cre-cert-6', title: 'Agency Law for NC Brokers', hours: 3, tier: 'mandatory' },
    { id: 'cre-cert-7', title: 'Listing Strategy in a Cooling Market', hours: 4, tier: 'elective' },
    { id: 'cre-cert-8', title: 'Luxury Home Marketing Specialist (Designation)', hours: 16, tier: 'elective' },
  ],
  // McKissock CE Membership catalog — 2026-2027 USPAP cycle plus the most-
  // surfaced appraisal CE titles from mckissock.com.
  mckissock: [
    { id: 'mck-cert-1', title: '2026-2027 7-Hour National USPAP Update', hours: 7, tier: 'mandatory' },
    { id: 'mck-cert-2', title: '7-Hour National Valuation Bias and Fair Housing', hours: 7, tier: 'mandatory' },
    { id: 'mck-cert-3', title: 'The FHA Handbook 4000.1', hours: 7, tier: 'elective' },
    { id: 'mck-cert-4', title: 'The Income Approach: An Overview', hours: 3, tier: 'elective' },
    { id: 'mck-cert-5', title: 'Small Spaces, Big Impact — Appraising ADUs', hours: 3, tier: 'elective' },
    { id: 'mck-cert-6', title: 'The Appraisal Landscape of Rural Residential Properties', hours: 5, tier: 'elective' },
    { id: 'mck-cert-7', title: 'Relocation Appraisal and the ERC Form', hours: 6, tier: 'elective' },
    { id: 'mck-cert-8', title: 'Supervisory Appraiser / Trainee Appraiser Course', hours: 4, tier: 'designated-mandatory' },
  ],
  // Florida biennial mandatory topics + popular Elite specialty-collection
  // titles from elitelearning.com/nursing.
  elite: [
    { id: 'elite-cert-1', title: 'Prevention of Medical Errors', hours: 2, tier: 'mandatory' },
    { id: 'elite-cert-2', title: 'Florida Laws and Rules for Nurses', hours: 2, tier: 'mandatory' },
    { id: 'elite-cert-3', title: 'Human Trafficking Awareness', hours: 2, tier: 'mandatory' },
    { id: 'elite-cert-4', title: 'Recognizing Impairment in the Workplace', hours: 2, tier: 'mandatory' },
    { id: 'elite-cert-5', title: 'HIV/AIDS — One-Time Florida Requirement', hours: 1, tier: 'designated-mandatory' },
    { id: 'elite-cert-6', title: 'Pharmacology Update for Nurses', hours: 6, tier: 'elective' },
    { id: 'elite-cert-7', title: 'Sepsis: Recognition & Response', hours: 3, tier: 'elective' },
    { id: 'elite-cert-8', title: 'Pediatric Nursing Specialty Collection', hours: 4, tier: 'elective' },
  ],
  fitzgerald: [
    { id: 'elite-cert-1', title: 'Prevention of Medical Errors', hours: 2, tier: 'mandatory' },
    { id: 'elite-cert-2', title: 'Florida Laws and Rules for Nurses', hours: 2, tier: 'mandatory' },
  ...
  stc: [
    { id: 'stc-cert-1', title: 'SIE Exam Prep — Completion', hours: 25, tier: 'mandatory' },
    { id: 'stc-cert-2', title: 'Series 7 Top-Off — Completion', hours: 45, tier: 'mandatory' },
    { id: 'stc-cert-3', title: 'Series 63 — State Law', hours: 12, tier: 'elective' },
    { id: 'stc-cert-4', title: 'Series 65 — Investment Adviser Law', hours: 18, tier: 'elective' },
    { id: 'stc-cert-5', title: 'Series 66 — Uniform Combined State Law', hours: 24, tier: 'mandatory' },
    { id: 'stc-cert-6', title: 'Series 24 — General Securities Principal', hours: 30, tier: 'elective' },
    { id: 'stc-cert-7', title: 'Series 79 — Investment Banking', hours: 22, tier: 'elective' },
    { id: 'stc-cert-8', title: 'Insurance Pre-Licensing — Life & Health', hours: 20, tier: 'designated-mandatory' },
  ],
...
/* Legacy default exports — point at CRE so any unupdated consumer still works.
   Prefer the `*For(brand)` helpers above in new code. */
export const MANDATORY_COURSES = mandatoryCoursesFor('cre')
export const MANDATORY_HOURS = _MANDATORY_HOURS_BY_BRAND.cre
export const ISSUED_CERTIFICATES = _CERTS_BY_BRAND.cre
