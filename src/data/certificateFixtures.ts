...
const APPRAISAL = 'Appraisal Continuing Education'
...
/* ── McKissock — appraisal CE (the original fixture set, unchanged) ────────
   ...
   fixture era (see `FIXTURE_TODAY` in myCoursesFixtures.ts). */
const _MCKISSOCK_CERTS: Certificate[] = [
  // ── Completed ──────────────────────────────────────────────────────────
  {
    id: 'cert-ga-laws',
    title: 'Laws and Regulations for GA Appraisers',
    ...
    status: 'completed',
    reporting: { status: 'reported', date: '2024-10-08' },
  },
  {
    id: 'cert-nc-laws',
    title: 'Laws and Regulations for NC Appraisers',
    profession: APPRAISAL,
  ...
  {
    id: 'cert-sc-laws',
    title: 'Laws and Regulations for SC Appraisers',
    profession: APPRAISAL,
    ...
    enrolledDate: '2024-06-10',
    status: 'completed',
    reporting: { status: 'non-reporting', stateAbbr: 'SC' },
  },
  {
    id: 'cert-tn-laws',
    title: 'Laws and Regulations for TN Appraisers',
    profession: APPRAISAL,
    state: 'Tennessee',
    hours: 3,
    badge: 'Mandatory',
    ...
    enrolledDate: '2024-06-10',
    status: 'completed',
    reporting: { status: 'reported', date: '2024-10-09' },
  },
  // The two records below are the ONLY McKissock certificates that carry a
  // `courseId`, and they exist for that reason. Every other one names an
  // appraisal course with no counterpart in `myCoursesFor('mckissock')` — the
  // certificate list and the course list were authored independently and the
  // titles do not correspond — so before these landed the brand rendered zero
  // certificate markers on a My Courses page holding six completed courses.
  // They point at real completed courses rather than inventing a third list.
  /* ── Completed certificates for the remaining completed McKissock courses ──
     Added 2026-09-08, same reason as the CRE pair: the card shows a marker only
     when a certificate points at the course, so these four completed courses
     rendered nothing. Note `mc-mck-uspap-24-25` is ARCHIVED and still gets one —
     archiving is a location, not a status, and the card is byte-identical
     either way, so an archived completed course keeps its certificate. */
  {
    id: 'cert-mck-income-approach',
    courseId: 'mc-mck-income-approach',
    ...
    status: 'completed',
    reporting: { status: 'reported', date: '2026-03-24' },
  },
  {
    id: 'cert-mck-residential-construction',
    courseId: 'mc-mck-residential-construction',
    ...
    enrolledDate: '2025-09-22',
    status: 'completed',
    reporting: { status: 'reported', date: '2025-11-07' },
  },
  {
    id: 'cert-mck-trainees',
    courseId: 'mc-mck-trainees',
    ...
    status: 'completed',
    reporting: { status: 'reported', date: '2026-01-27' },
  },
  {
    id: 'cert-mck-uspap-24-25',
    courseId: 'mc-mck-uspap-24-25',
    title: '2024-2025 7-Hour National USPAP Update Course',
    profession: APPRAISAL,
    // Federal, so `reported` and NOT `non-reporting` — that variant's copy
    // interpolates a state abbreviation ("{stateAbbr} is a Non-Reporting
    // State") and has nothing to say about a federal course.
    state: 'Federal',
    hours: 7,
    badge: 'Mandatory',
    completedDate: '2025-01-16',
    enrolledDate: '2024-12-04',
    status: 'completed',
    reporting: { status: 'reported', date: '2025-01-20' },
  },
  {
    id: 'cert-mck-bias-fair-housing',
    courseId: 'mc-mck-bias-fair-housing',
    ...
    status: 'completed',
    reporting: { status: 'reported', date: '2026-04-07' },
  },
  {
    id: 'cert-industrial-flex',
    title: 'Appraisal of Industrial and Flex Buildings',
    profession: APPRAISAL,
    state: 'Georgia',
    hours: 7,
    badge: 'Elective',
  ...
  {
    id: 'cert-ext-green-ga',
    title: 'Online Correspondence: Basics of Green Building for Real Estate',
    profession: 'Real Estate Continuing Education',
    state: 'Georgia',
    hours: 4,
    badge: 'Mandatory',
    ...
    status: 'external',
    externalProvider: 'Calypso Continuing Education',
    reporting: { status: 'reported', date: '2024-08-09' },
  },
  {
    id: 'cert-ext-green-nc',
    title: 'Online Correspondence: Basics of Green Building for Real Estate',
    profession: 'Real Estate Continuing Education',
    state: 'North Carolina',
    hours: 4,
    ...
    status: 'external',
    externalProvider: 'Calypso Continuing Education',
    reporting: { status: 'non-reporting', stateAbbr: 'NC' },
  },
  {
    id: 'cert-ext-green-sc',
    title: 'Online Correspondence: Basics of Green Building for Real Estate',
    profession: 'Real Estate Continuing Education',
    state: 'South Carolina',
    hours: 4,
  ...
  // ── Action required ────────────────────────────────────────────────────
  {
    id: 'cert-ar-industrial-survey',
    title: 'Appraisal of Industrial and Flex Building',
    profession: APPRAISAL,
    state: 'South Carolina',
    hours: 6,
    badge: 'Mandatory',
  ...
  {
    id: 'cert-ar-sc-survey-proctor',
    title: 'South Carolina Surveying Standards of Practice',
    profession: APPRAISAL,
    state: 'South Carolina',
    hours: 6,
    badge: 'Mandatory',
  ...
  {
    id: 'cert-ar-nc-payment',
    title: 'North Carolina Surveying Standards of Practice',
    profession: APPRAISAL,
    state: 'North Carolina',
    hours: 6,
    badge: 'Mandatory',
  ...
  {
    id: 'cert-ar-ga-document',
    title: 'Georgia Surveying Standards of Practice',
    profession: APPRAISAL,
    state: 'Georgia',
    hours: 6,
    badge: 'Mandatory',
  ...
  {
    id: 'cert-mck-ar-cost-approach-survey',
    courseId: 'mc-mck-cost-approach',
    ...
    status: 'action-required',
    action: 'survey',
    rosterReported: 'Held pending survey',
  },
  {
    id: 'cert-ar-tn-affidavit',
    title: 'Tennessee Surveying Standards of Practice',
    profession: APPRAISAL,
    state: 'Tennessee',
    hours: 6,
    badge: 'Mandatory',
...
/* ── Colibri Real Estate — NC primary licensed state, GA secondary ─────────
   ...
   learner has completed in `myCoursesFor('cre')`. */
const _CRE_CERTS: Certificate[] = [
  /* ── Completed certificates for the remaining completed CRE courses ─────
     Added 2026-09-08. The card only shows a certificate marker when a
     certificate actually points at the course — it does not assume one from a
     completed status, which is the over-claim the join replaced. So a completed
     course with no record showed nothing, and these two were the CRE gap.
     Fields mirror the course record exactly (title / hours / state / badge and
     both dates), because a certificate that disagrees with the course it was
     issued for is worse than no certificate. */
  {
    id: 'cert-cre-fair-housing',
    courseId: 'mc-fair-housing',
    title: 'Fair Housing',
    profession: RE_CE,
    state: 'Georgia',
    hours: 4,
    ...
    status: 'completed',
    reporting: { status: 'reported', date: '2026-01-12' },
  },
  {
    id: 'cert-cre-millennials',
    courseId: 'mc-millennials-3',
    ...
    status: 'completed',
    reporting: { status: 'reported', date: '2026-03-18' },
  },
  // ── Completed ──────────────────────────────────────────────────────────
  {
    id: 'cert-cre-nc-update',
    courseId: 'lp-cre-nc-update',
    ...
    status: 'completed',
    reporting: { status: 'reported', date: '2026-03-05' },
  },
  {
    id: 'cert-cre-nc-bicup',
    courseId: 'lp-cre-nc-bicup',
    title: 'Broker-in-Charge Update (BICUP)',
    profession: RE_CE,
    state: 'North Carolina',
    hours: 4,
    badge: 'Mandatory',
  ...
  {
    // Matches the completed `mc-agency-law` record in myCoursesFor('cre').
    id: 'cert-cre-agency-law',
    courseId: 'mc-agency-law',
    title: 'Agency Law',
    profession: RE_CE,
    state: 'Georgia',
    hours: 4,
    ...
    status: 'completed',
    reporting: { status: 'non-reporting', stateAbbr: 'GA' },
  },
  {
    // Matches `mc-implicit-bias`.
    id: 'cert-cre-implicit-bias',
    courseId: 'mc-implicit-bias',
    ...
    status: 'completed',
    reporting: { status: 'reported', date: '2026-03-13' },
  },
  {
    // Matches `mc-workforce-housing`.
    id: 'cert-cre-workforce-housing',
    courseId: 'mc-workforce-housing',
  ...
  // ── Externally completed ───────────────────────────────────────────────
  {
    id: 'cert-cre-ext-green-building',
    title: 'Online Correspondence: Basics of Green Building for Real Estate',
    profession: RE_CE,
    state: 'North Carolina',
    hours: 4,
    ...
    enrolledDate: '2025-12-02',
    status: 'external',
    externalProvider: 'Calypso Continuing Education',
    reporting: { status: 'reported', date: '2026-01-17' },
  },
  {
    id: 'cert-cre-ext-nar-ethics',
    title: 'Code of Ethics Training — Cycle 8',
    profession: RE_CE,
    state: 'Georgia',
    hours: 3,
    badge: 'Mandatory',
    ...
    status: 'external',
    externalProvider: 'National Association of REALTORS®',
    reporting: { status: 'non-reporting', stateAbbr: 'GA' },
  },

  // ── Action required ────────────────────────────────────────────────────
  {
    id: 'cert-cre-ar-bpos-survey',
    courseId: 'mc-bpo',
    ...
    enrolledDate: '2026-02-24',
    status: 'action-required',
    action: 'survey',
    rosterReported: 'Pending Roster Submission',
  },
  {
    id: 'cert-cre-ar-fair-housing-document',
    courseId: 'lp-cre-fair-housing',
    title: 'Fair Housing — Source-of-Income Protections',
    profession: RE_CE,
    state: 'North Carolina',
    hours: 4,
    badge: 'Elective',
  ...
  {
    id: 'cert-cre-ar-listing-strategy-payment',
    courseId: 'lp-cre-listing-strategy',
  ...
  {
    id: 'cert-cre-ar-agency-law-affidavit',
    title: 'Agency Law for NC Brokers',
    profession: RE_CE,
    state: 'North Carolina',
    hours: 3,
    badge: 'Mandatory',
  ...
  {
    id: 'cert-cre-ar-luxury-proctor',
    title: 'Luxury Home Marketing Specialist (Designation)',
    profession: 'Professional Designation',
    state: 'North Carolina',
    hours: 16,
    badge: 'Elective',
