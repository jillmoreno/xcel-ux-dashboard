...
const ELITE_JUST_LAUNCHED: JustLaunchedItem[] = [
  {
    id: 'interview-sim',
    kicker: 'New AI tool',
    title: 'Nursing interview practice simulation',
    blurb:
      'Rubi AI runs realistic nursing interview reps and gives you instant, specific feedback.',
    contentType: 'tool',
    contentLabel: 'AI tool',
    iconKey: 'robot',
    tier: 'passport',
    accent: 'cta',
    ctaLabel: 'Start a session',
    href: '/membership/passport/interview-sim',
    coverLabel: 'Rubi™ Coach',
  },
  {
    id: 'med-mysteries',
    kicker: 'New podcast series',
    title: 'Medical Mysteries: a CE podcast',
    blurb:
      'Earn CE while you listen — a new narrative series breaking down real clinical cases.',
    contentType: 'podcast',
    ...
    // Real cover art (Elite Learning's "CE Podcasts for Nurses", Apple CDN).
    // TODO(prod): self-host this asset + confirm brand-usage rights.
    image:
      'https://is1-ssl.mzstatic.com/image/thumb/Podcasts221/v4/81/8e/72/818e72e4-b832-f95c-c816-7c13a1a8f633/mza_15306628706757429593.jpg/1200x1200bf-60.jpg',
  },
  {
    id: 'cert-exam-prep',
    kicker: 'Just added',
    ...
    blurb:
      'New CCRN, CMSRN, CEN and PCCN prep bundles — practice tests and full study plans.',
    contentType: 'certificate',
    contentLabel: 'Exam prep',
    iconKey: 'award',
    tier: 'passport',
    accent: 'teal',
    ctaLabel: 'Explore prep',
    href: '/membership/passport/cert-exam-prep',
    coverLabel: 'CCRN · CMSRN · CEN · PCCN',
  },
  {
    id: 'role-transition-ce',
    kicker: 'New course track',
    title: 'Transitions in Practice: critical care',
    blurb:
      'A guided CE track for nurses moving into the ICU — assessment, recognition, response.',
    contentType: 'course',
    contentLabel: 'Course track',
    iconKey: 'briefcase',
    tier: 'passport',
    accent: 'teal',
    ctaLabel: 'Start track',
    href: '/my-learning/path',
    coverLabel: 'ICU readiness',
  },
]
...
const ELITE_BENEFIT_ROWS: BenefitRow[] = [
  {
    id: 'learning-library',
    eyebrow: 'Keep your skills sharp',
    title: 'Resource Library',
    blurb:
      'On-demand CE, video skills refreshers, and specialty libraries — all included.',
    subtext:
      'Dive into a curated library of on-demand videos, articles, and quick-reference guides you can put to use between shifts.',
    exploreLabel: 'Browse the library',
    exploreHref: '/membership?tab=library',
    accent: 'teal',
    tierChips: ['lite'],
    items: [
      {
        ...
        meta: 'On-demand · technique refreshers',
        iconKey: 'video',
        contentType: 'video',
        tier: 'passport',
        href: '/membership/passport/video-skills-library',
      },
      {
        id: 'pharmacology-library',
        title: 'Pharmacology course library',
        meta: 'Medications · dosing · safety',
        iconKey: 'book-open',
        contentType: 'course',
        tier: 'passport',
        href: '/membership/passport/pharmacology-library',
      },
      {
        id: 'specialty-bundles',
        title: 'In-depth specialty bundles',
        meta: 'Deep dives by specialty',
        iconKey: 'books',
        contentType: 'bundle',
        tier: 'passport',
        href: '/membership/passport/specialty-bundles',
      },
      {
        id: 'iv-therapy',
        title: 'IV Therapy & Vascular Access',
        meta: '1.5 CE hrs · Med-Surg',
  ...
  },
  {
    ...
    title: 'CE Podcasts',
    blurb:
      'Accredited audio learning for your commute — also included with Passport Lite.',
    subtext:
      'Earn accredited CE on the go with bite-size audio episodes across clinical topics and specialties, refreshed regularly.',
    exploreLabel: 'Browse podcasts',
    exploreHref: '/my-learning/podcasts',
    accent: 'gold',
    podcast: true,
    tierChips: ['open'],
    items: [
      {
        ...
        meta: 'New series · 6 episodes',
        episodeMeta: 'Ep. 42 · 1 hr',
        creditChips: ['Mandatory', '1 Hour', 'NC'],
        iconKey: 'podcast',
        contentType: 'podcast',
        tier: 'both',
        isNew: true,
      ...
      {
        id: 'phantom-fever',
        title: 'The Phantom Fever',
        meta: 'Diagnostics · 52 min',
        episodeMeta: 'Ep. 38 · 1 hr',
        creditChips: ['Mandatory', '1 Hour', 'NC'],
        iconKey: 'podcast',
        contentType: 'podcast',
        tier: 'both',
      ...
      {
        id: 'scrubs-subpoenas',
        title: 'Scrubs & Subpoenas',
        meta: 'Documentation · 47 min',
        episodeMeta: 'Ep. 27 · 45 min',
        creditChips: ['Elective', '0.75 Hours', 'AL'],
        iconKey: 'podcast',
        contentType: 'podcast',
        tier: 'both',
        href: '/my-learning/podcasts',
      },
      {
        ...
        title: 'Precision Medicine in Mental Health',
        meta: 'Psych · 1 hr',
        episodeMeta: 'Ep. 12 · 1 hr',
        creditChips: ['Elective', '1 Hour', 'VA'],
        iconKey: 'podcast',
        contentType: 'podcast',
        tier: 'both',
        href: '/my-learning/podcasts',
  ...
  {
    id: 'exam-prep',
    eyebrow: 'Earn a specialty credential',
    title: 'Exam & Certification Prep',
    blurb:
      'Practice tests and study plans for the most-requested nursing certifications.',
    subtext:
      'Prepare for CCRN, PCCN, CMSRN, CEN and more with full study plans, scored practice questions, and expert answer rationales.',
    exploreLabel: 'View all prep',
    exploreHref: '/membership/passport/cert-exam-prep',
    accent: 'teal',
    items: [
      {
        id: 'ccrn-review',
        title: 'CCRN Review',
        meta: 'Adult Critical Care · study plan',
        iconKey: 'award',
        contentType: 'certificate',
        tier: 'passport',
        isNew: true,
  ...
  {
    id: 'career-tools',
    eyebrow: 'Get ahead in your career',
    title: 'AI Career Tools',
    blurb:
      'Your AI career coach, powered by Rubi AI — interview reps, resume help, and next-move planning.',
    subtext:
      'Practice interviews, sharpen your resume, and map your next move with AI-powered career tools available on demand.',
    exploreLabel: 'Explore tools',
    exploreHref: '/membership/passport/interview-sim',
    accent: 'cta',
    tierChips: ['passport'],
    items: [
      {
      ...
      },
      {
        id: 'resume-builder',
        title: 'Resume Review',
        meta: 'Role-specific feedback',
        bullets: [
          'Tailored to your target role',
          'Flags gaps and weak phrasing',
          'Suggested rewrites in seconds',
        ],
        iconKey: 'file-lines',
        contentType: 'tool',
        tier: 'passport',
        href: '/membership/passport/resume-builder',
      },
      {
        id: 'career-paths',
        title: 'Career Path Explorer',
        meta: 'Map your next role',
        bullets: [
          'See roles that fit your skills',
          'Compare pay and demand',
          'Get a step-by-step plan',
        ],
        iconKey: 'flag',
        contentType: 'tool',
        tier: 'passport',
        href: '/membership/passport/career-paths',
      },
      {
        id: 'role-transition-ce',
        title: 'Transitions in Practice',
        meta: 'Specialty & role-change CE',
        iconKey: 'briefcase',
        contentType: 'course',
        tier: 'passport',
        href: '/my-learning/path',
  ...
  // ── Rebrand "What's New" only (scope: 'rebrand') ──────────────────────────
  // Surfaced by `ExploreMembershipProducts` via `only`; the navy `tile` band
  // (tileGradient) sets Exam & Cert Prep apart from the teal Transitions tiles.
  {
    id: 'exam-specialties',
    scope: 'rebrand',
    eyebrow: 'Earn a specialty credential',
    ...
    tierChips: ['passport'],
    tileGradient:
      'linear-gradient(140deg, var(--color-primary-700), var(--color-primary-800))',
    items: [
      {
        id: 'or-pacu',
        title: 'OR / PACU',
  ...
  },
  {
    id: 'transitions',
    scope: 'rebrand',
    eyebrow: 'Move into a new role',
    title: 'Transitions in Practice',
    blurb:
      'Guided certification-review tracks for nurses stepping into a new specialty.',
    subtext:
      'Step confidently into a new specialty with structured, role-based learning paths that build the skills each transition demands.',
    exploreLabel: 'View all 7',
    exploreHref: '/my-learning/path',
    accent: 'teal',
    tierChips: ['passport', 'lite'],
    items: [
      {
        id: 'ccrn-review',
        title: 'CCRN Review',
