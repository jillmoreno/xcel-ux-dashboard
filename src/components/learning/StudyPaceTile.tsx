...
export type StudyPaceTileProps = {
   ...
   */
  layout?: 'tile' | 'card'
  /** The card layout's shell. Default `ruled` (hairline, 2px corners);
   *  `framed` is the Atlas home's — white, no stroke, `--radius-lg`;
   *  `outlined` is the same shell with no fill and a 1px rail-edge border. */
  cardSurface?: 'ruled' | 'framed' | 'outlined'
  /**
  ...
  return (
    <>
      <SquareTile
        ...
        square={!card}
        surface={card ? cardSurface : 'recessed'}
        action={
          card ? undefined : (
          <button
            type="button"
