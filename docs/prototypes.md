...
### The learner home — the seventh page with no row
...
product renders at `/dashboard-rebrand?demo=1` (the QE Focused version as of
2026-09-21 — `?demo=1` opens Testing now). It is **not** a
`PROTOTYPE_FEATURES` row, same reasoning as the six pages above: the
...
eighth, `smoke-pace-readiness.mjs`, on 2026-09-17, and a ninth and tenth,
`smoke-pace-presets.mjs` and `smoke-home.mjs`, on 2026-09-21. Run them
with **`npm run smoke`** — 41 + 48 + 210 + 42 + 58 + 75 + 56 + 57 + 66 + 21 = **674 assertions**. Two things
